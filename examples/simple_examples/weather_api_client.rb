...
#
# This client demonstrates the usage of the weather API server.
# It connects to weather_api_server.rb and requests real weather data.
#
# Usage:
#   ruby weather_api_client.rb

require_relative '../../lib/mcp/client/stdio'
require 'json'

# サーバーに接続
MCP::Client::Stdio.connect(['ruby', 'weather_api_server.rb']) do |client|
  # クライアントを初期化
  client.initialize!
