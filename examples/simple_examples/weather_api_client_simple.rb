#!/usr/bin/env ruby
# weather_api_client_simple.rb
#
# This client demonstrates the usage of the weather API server with embedded key.
# It connects to weather_api_server_with_key.rb for simpler execution.
#
# Usage:
#   ruby weather_api_client_simple.rb

require_relative '../../lib/mcp/client/stdio'
require 'json'

# サーバーに接続（APIキー埋め込み版のサーバーを使用）
MCP::Client::Stdio.connect(['ruby', 'weather_api_server_with_key.rb']) do |client|
  # クライアントを初期化
  client.initialize!
